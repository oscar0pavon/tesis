...
% ESTE ES EL NÚCLEO 100% TUYO. No se puede generar con IA ni inventar:
%   - METODOLOGÍA: describí lo que VOS hiciste (cómo montaste y mediste el experimento).
%   - PROTOTIPO EN C: es tu prueba de autoría. Versionalo en git (commits con fecha);
%     incluí fragmentos clave con \begin{lstlisting} y el código completo en anexos.
%   - DATOS REALES: las tablas/figuras van con TUS mediciones (tiempos, productividad,
%     inanición). Inventar o falsear datos = fraude académico.
%   - ANÁLISIS: la interpretación de los resultados es lo más valioso de la tesis;
%     escribila vos. Podés citar teoría del Marco Teórico para contrastar.
% ============================================================
